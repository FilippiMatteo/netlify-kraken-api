...
export const fetchDataFromApi = async function (queryString, param, type) {
    const urlheroku = 'https://heroku-kraken-nodejs.herokuapp.com/kraken/';
    const urllocal = 'http://localhost:3000/kraken/'

    const rawData = await fetch(urllocal +queryString, {
        method: type || "GET",
